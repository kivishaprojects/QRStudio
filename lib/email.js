    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:auto;color:#1b2138">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px">
          ...
          <tr><td style="padding:6px 0;color:#5f6982">Amount paid</td><td style="text-align:right"><b>₹${o.amount}</b></td></tr>
        ...
        <p style="color:#5f6982;font-size:12px;margin-top:20px">Thank you for using QR Studio · Developed by Jupiter Technologies.</p>
      </div>`;
