  ...
  try {
    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:auto;color:#1b2138">
        ...
        <p style="color:#5f6982;font-size:12px;margin-top:20px">Prices are inclusive of GST @ ${RATE}%. Thank you for using QR Studio · Developed by Jupiter Technologies.</p>
      </div>`;
